...
{
    /// <summary>
    /// Some objects might need to on a slower update loop than the usual MonoBehaviour Update and without precise timing.
    /// E.g. to refresh data from services.
    ...
    public class UpdateRunner : MonoBehaviour
    {
        ...
        /// Don't assume that onUpdate will be called in any particular order compared to other subscripters.
        /// </summary>
        public void Subscribe(Action<float> onUpdate, float updatePeriod)
        {
            ...
            {
                Debug.LogError("Can't subscribe to an anonymous function that cannot be Unsubscribed from, by checking for a character that can't exist in a declared method name.");
                return;
            }
        ...
        /// <summary>
        /// Each frame, advance all subscribers. Any that have hit their perioud should then act, though if they take too long they could be removed.
        /// </summary>
        void Update()
        {
